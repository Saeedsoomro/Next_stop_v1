...
import HomepageDeclinedBottomsheet from '../../components/HomepageDeclinedBottomsheet';
import {useSelector} from 'react-redux';

export default function HomepageDeclined({navigation, route}) {
  const {selectedValue1} = route.params;
  const {declinedOrders, newOrders} = useSelector(state => state.order);
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  style={[
                    styles.button,
                    {width: 150, backgroundColor: '#0af906'},
                  ]}>
                  <Text style={styles.buttonText}>View Missing Items</Text>
                </TouchableOpacity>
              </View>
            </View>
          ))}
